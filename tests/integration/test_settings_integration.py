...
class TestSettingsIntegration:
    ...
    def mock_settings(self):
        ...
        class MockSettings:
            def __init__(self, **kwargs):
                ...
                self.anime_database_url = kwargs.get('anime_database_url', 'https://example.com/anime.json')
                ...
                self.api_description = kwargs.get('api_description', 'Semantic search API')
    ...
    def test_qdrant_client_settings_integration(self, mock_settings):
        ...
        assert client_with_settings.collection_name == mock_settings.qdrant_collection_name
        assert client_with_settings._vector_size == mock_settings.qdrant_vector_size
        assert client_with_settings._distance_metric == mock_settings.qdrant_distance_metric
    ...
    def test_data_service_settings_integration(self, mock_settings):
        ...
        assert service_with_settings.max_concurrent_batches == mock_settings.max_concurrent_batches
        assert service_with_settings.processing_timeout == mock_settings.processing_timeout
    ...
    def test_fastapi_app_settings_integration(self, mock_settings):
        ...
        assert app_with_settings.cors_config['allow_origins'] == mock_settings.allowed_origins
        assert app_with_settings.cors_config['allow_methods'] == mock_settings.allowed_methods
        assert app_with_settings.cors_config['allow_headers'] == mock_settings.allowed_headers
