...
class TestVisionProcessor:
    ...
    def test_init_with_defaults(self):
        ...
        with patch('src.vector.vision_processor.clip') as mock_clip, \
            ...
            mock_clip.load.assert_called_once_with("ViT-B/32", device="cpu", download_root=None)
    ...
    def test_init_with_custom_params(self):
        ...
        with patch('src.vector.vision_processor.clip') as mock_clip, \
            ...
            mock_clip.load.assert_called_once_with("ViT-L/14", device="cuda", download_root="/tmp/clip")
    
    def test_init_missing_dependencies(self):
        """Test VisionProcessor initialization when CLIP dependencies are missing."""
        with patch('src.vector.vision_processor.torch', side_effect=ImportError("torch not found")):
