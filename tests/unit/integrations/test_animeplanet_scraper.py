...
<body>
    ...
    @pytest.mark.asyncio
    async def test_get_anime_by_slug_success(
        self, animeplanet_scraper, sample_anime_html
    ):
        """Test successful anime retrieval by slug."""
        slug = "death-note"

        with patch.object(
            animeplanet_scraper, "_make_request", new_callable=AsyncMock
        ) as mock_request:
    ...
    async def test_cache_exception_handling_coverage(self, animeplanet_scraper):
        ...
        animeplanet_scraper.cache_manager.get = AsyncMock(
            side_effect=Exception("Cache error")
        )
        animeplanet_scraper.cache_manager.set = AsyncMock(
            side_effect=Exception("Cache error")
        )
    ...
    @pytest.mark.asyncio
    async def test_circuit_breaker_exception_propagation_coverage(
        self, animeplanet_scraper
    ):
    ...
    def test_parse_single_search_result_fallback_title_coverage(
        self, animeplanet_scraper
    ):
    ...
    def test_parse_single_search_result_no_title_or_slug_coverage(
        self, animeplanet_scraper
    ):
    ...
    def test_parse_single_search_result_with_synopsis_coverage(
        self, animeplanet_scraper
    ):
    ...
    def test_parse_single_search_result_short_synopsis_coverage(
        self, animeplanet_scraper
    ):
    ...
    def test_parse_search_results_fallback_selectors_coverage(
        self, animeplanet_scraper
    ):
    ...
    async def test_final_100_percent_coverage_lines(self, animeplanet_scraper):
        ...
        try:
            ...
            with patch.object(
                animeplanet_scraper, "_clean_text", side_effect=Exception("Parse error")
            ):
                animeplanet_scraper._parse_single_search_result(card)
    ...
    async def test_anime_planet_lines_211_215_exact_coverage(self, animeplanet_scraper):
        ...
        with patch.object(
            ...
            with patch.object(
                animeplanet_scraper, "_parse_search_results", return_value=[]
            ):
