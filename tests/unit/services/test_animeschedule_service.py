...
class TestAnimeScheduleService:
    ...
    def animeschedule_service(self):
        ...
        with (
            patch(
                "src.services.external.animeschedule_service.AnimeScheduleClient"
    ...
    @pytest.mark.asyncio
    async def test_get_today_timetable_success(
        self, animeschedule_service, sample_timetable_data
    ):
        ...
        animeschedule_service.client.get_today_timetable.return_value = (
    ...
    @pytest.mark.asyncio
    async def test_get_today_timetable_default_params(
        self, animeschedule_service, sample_timetable_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_timetable_by_date_success(
        self, animeschedule_service, sample_timetable_data
    ):
        ...
        animeschedule_service.client.get_timetable_by_date.return_value = (
            sample_timetable_data
        )
    ...
    @pytest.mark.asyncio
    async def test_get_seasonal_anime_success(
        self, animeschedule_service, sample_seasonal_data
    ):
        ...
        animeschedule_service.client.get_seasonal_anime.return_value = (
        ...
        animeschedule_service.client.get_seasonal_anime.assert_called_once_with(
            season, year
        )
    ...
    async def test_get_anime_schedule_success(self, animeschedule_service):
        ...
        schedule_data = {
            ...
            "broadcast_info": {"network": "NHK", "timezone": "Asia/Tokyo"},
        }

        animeschedule_service.client.get_anime_schedule_by_id.return_value = (
            schedule_data
        )
        ...
        animeschedule_service.client.get_anime_schedule_by_id.assert_called_once_with(
            anime_id
        )
    ...
    async def test_get_streaming_platforms_success(self, animeschedule_service):
        ...
        animeschedule_service.client.get_streaming_platforms.return_value = (
            platforms_data
        )
    ...
    async def test_health_check_healthy(self, animeschedule_service):
        ...
        animeschedule_service.client.check_api_compatibility.return_value = (
            compatibility_data
        )
    ...
    async def test_health_check_unhealthy(self, animeschedule_service):
        ...
        # Setup
        animeschedule_service.client.check_api_compatibility.side_effect = Exception(
            "Service down"
        )
