...
class TestAnimePlanetService:
    ...
    def animeplanet_service(self):
        ...
        with patch('src.services.external.animeplanet_service.AnimePlanetScraper') as mock_scraper_class, \
    ...
    @pytest.mark.asyncio
    async def test_search_anime_success(self, animeplanet_service, sample_search_results):
    ...
    async def test_search_anime_failure(self, animeplanet_service):
        ...
        # Setup
        animeplanet_service.scraper.search_anime.side_effect = Exception("Scraping error")
    ...
    @pytest.mark.asyncio
    async def test_get_anime_details_success(self, animeplanet_service, sample_anime_data):
    ...
    @pytest.mark.asyncio
    async def test_get_anime_characters_success(self, animeplanet_service, sample_character_data):
    ...
    @pytest.mark.asyncio
    async def test_get_anime_recommendations_success(self, animeplanet_service, sample_recommendations_data):
    ...
    @pytest.mark.asyncio
    async def test_get_anime_recommendations_default_limit(self, animeplanet_service, sample_recommendations_data):
    ...
    @pytest.mark.asyncio
    async def test_get_top_anime_success(self, animeplanet_service, sample_top_anime_data):
    ...
    @pytest.mark.asyncio
    async def test_get_top_anime_default_params(self, animeplanet_service, sample_top_anime_data):
