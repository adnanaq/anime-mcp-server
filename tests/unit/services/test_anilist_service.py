...
class TestAniListService:
    ...
    def anilist_service(self):
        ...
        with patch('src.services.external.anilist_service.AniListClient') as mock_client_class, \
    ...
    async def test_health_check_unhealthy(self, anilist_service):
        ...
        # Setup
        anilist_service.client.get_trending_anime.side_effect = Exception("Service down")
