...
class TestAniSearchAPI:
    ...
    def test_get_anime_characters_service_error(self, mock_service, client):
        ...
        # Setup
        mock_service.get_anime_characters = AsyncMock(side_effect=Exception("Scraping error"))
    ...
    def test_get_anime_recommendations_success(self, mock_service, client, sample_recommendations_data):
        ...
        # Execute
        response = client.get(f"/external/anisearch/anime/{anime_id}/recommendations?limit={limit}")
    ...
    def test_get_top_anime_success(self, mock_service, client, sample_top_anime_data):
        ...
        # Execute
        response = client.get(f"/external/anisearch/top?category={category}&limit={limit}")
    ...
    def test_get_seasonal_anime_success(self, mock_service, client, sample_seasonal_data):
        ...
        # Execute
        response = client.get(f"/external/anisearch/seasonal?year={year}&season={season}&limit={limit}")
    ...
    @patch('src.api.external.anisearch._anisearch_service')
    def test_get_seasonal_anime_default_params(self, mock_service, client, sample_seasonal_data):
    ...
    def test_get_seasonal_anime_service_error(self, mock_service, client):
        ...
        # Setup
        mock_service.get_seasonal_anime = AsyncMock(side_effect=Exception("Scraping error"))
