...
class TestAniDBAP:
    ...
    @patch('src.api.external.anidb._anidb_service')
    def test_get_anime_episodes_success(self, mock_service, client, sample_episode_data):
    ...
    @patch('src.api.external.anidb._anidb_service')
    def test_get_similar_anime_success(self, mock_service, client, sample_search_results):
    ...
    @patch('src.api.external.anidb._anidb_service')
    def test_get_similar_anime_default_limit(self, mock_service, client, sample_search_results):
    ...
    def test_get_random_anime_service_error(self, mock_service, client):
        ...
        # Setup
        mock_service.get_random_anime = AsyncMock(side_effect=Exception("Service error"))
