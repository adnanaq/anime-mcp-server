...
class TestKitsuClient:
        ...
        return {
            "data": {
                ...
                "attributes": {
                    ...
                    "averageRating": "82.74",
                    "ratingFrequencies": {"2": "832", "3": "81", "4": "106"},
                    "userCount": 64304,
                    "favoritesCount": 4312,
    ...
    async def test_get_anime_by_id_success(self, kitsu_client, sample_anime_response):
        ...
        with patch.object(
            kitsu_client, "_make_request", new_callable=AsyncMock
        ) as mock_request:
    ...
    async def test_search_anime_with_filters(
        self, kitsu_client, sample_search_response
    ):
        ...
        with patch.object(
            ...
            results = await kitsu_client.search_anime(
                query=query, categories=categories, year=year, limit=5
            )
    ...
    @pytest.mark.asyncio
    async def test_get_streaming_links(
        self, kitsu_client, sample_streaming_links_response
    ):
        ...
        with patch.object(
            ...
            assert (
                streaming_links[0]["attributes"]["url"]
                == "https://www.crunchyroll.com/cowboy-bebop"
            )
    ...
    async def test_json_api_request_success(self, kitsu_client):
        ...
        with patch("aiohttp.ClientSession.get") as mock_get:
            ...
            mock_response.json = AsyncMock(
                return_value={"data": {"id": "1", "type": "anime"}}
            )
    ...
    async def test_cache_integration(self, kitsu_client, sample_anime_response):
        ...
        # Mock cache hit
        kitsu_client.cache_manager.get = AsyncMock(
            return_value=sample_anime_response["data"]
        )
    ...
    async def test_relationship_data_parsing(self, kitsu_client):
        ...
        with patch.object(
            ...
            result = await kitsu_client.get_anime_by_id(
                anime_id, includes=["categories"]
            )
