...
async def process_smart_conversation(request: SmartConversationRequest) -> ConversationResponse:
    ...
    try:
        ...
        if hasattr(result_state, 'conversation_summary') and result_state.conversation_summary:
        ...
        raise HTTPException(status_code=500, detail=f"Smart conversation processing error: {str(e)}")
