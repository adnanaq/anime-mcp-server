...
class AnimePlanetEnrichmentHelper:
    ...
    async def find_animeplanet_url(self, offline_anime_data: Dict[str, Any]) -> Optional[str]:
    ...
    async def search_anime_by_title(self, title: str, limit: int = 5) -> Optional[Dict[str, Any]]:
    ...
    async def fetch_all_data(self, offline_anime_data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
