...
class VisionProcessor:
    ...
    def _init_clip_model(self):
        ...
        try:
            ...
            logger.info(f"Initialized CLIP model ({self.model_name}) on device: {self.device}")
    ...
    def _generate_embedding(self, processed_image: 'torch.Tensor') -> Optional[List[float]]:
    ...
    def encode_images_batch(self, image_data_list: List[str], batch_size: int = 32) -> List[Optional[List[float]]]:
