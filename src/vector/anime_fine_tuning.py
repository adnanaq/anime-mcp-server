...
class AnimeFineTuner:
    ...
    def __init__(self, settings: Optional[Settings] = None):
        ...
        self.character_finetuner = CharacterRecognitionFinetuner(settings)
        self.art_style_classifier = ArtStyleClassifier(settings)
        self.genre_enhancer = GenreEnhancementFinetuner(settings)
