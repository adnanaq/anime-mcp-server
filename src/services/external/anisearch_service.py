...
class AniSearchService(BaseExternalService):
    ...
    async def get_top_anime(self, category: str = "highest_rated", limit: int = 25) -> List[Dict[str, Any]]:
        ...
        """
        valid_categories = [
            "highest_rated", "most_popular", "newest", 
            "most_watched", "most_favorites", "recently_updated"
        ]
    ...
    async def get_seasonal_anime(self, year: Optional[int] = None, season: Optional[str] = None, limit: int = 25) -> List[Dict[str, Any]]:
        ...
        try:
            logger.info("AniSearch seasonal anime: year=%d, season='%s', limit=%d", year, season, limit)
    ...
    async def get_popular_anime(self, time_period: str = "all_time", limit: int = 25) -> List[Dict[str, Any]]:
        ...
        try:
            logger.info("AniSearch popular anime: time_period='%s', limit=%d", time_period, limit)
