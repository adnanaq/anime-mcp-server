...
class ModernServiceManager:
    ...
    def __init__(self, settings: Settings):
        ...
        logger.info("ModernServiceManager initialized with direct tool call architecture")
    ...
    async def search_anime_direct(
        ...
        **kwargs
        ...
        if platform and platform in self.clients:
            platform_order = [platform] + [p for p in self.platform_priorities if p != platform]
        else:
